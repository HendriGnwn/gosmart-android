...
import com.atc.gosmartlesmagistra.activity.PrivateOrderActivity;
...
public class OrderHistoryExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<Order> list; // header titles
    // child data in format of header title, child title
    private HashMap<String, List<String>> _listDataChild;

    public OrderHistoryExpandableListAdapter(Context context, List<Order> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        final Order order = (Order) list.get(groupPosition);
        ...
        status.setText("Status: " + order.getStatusMessage());
...
//        });
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (view == null) {
            LayoutInflater infalInflater = (LayoutInflater) this.context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = infalInflater.inflate(R.layout.order_history_list, null);
        }
